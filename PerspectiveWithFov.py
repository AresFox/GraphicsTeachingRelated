...
#         # 记录线段
#         LineAC = Line(axes.c2p(0, 0), pointA,color=BLU E)
...
#         v_line =
#
#         always_redraw(lambda: axes.get_v_line(pointA.get_bottom()))
#         self.play(
#             ShowCreation(v_line),
#             run_time=0.1,
#         )
...
#         ybili = Text("\frac{y'}{y} = -\frac{n}{z}", font_size=20, color=WHITE, t2c={"y": RED, "n": GREEN, "z": BLUE})
#         # ybili = Text("y’ / y = -n / z", font_size=20)
#         ybili.next_to(axes.c2p(4, 4), DOWN)
#         self.add(ybili)
#
#         ybili2 = Text("y’ = -n / z * y", font_size=20)
